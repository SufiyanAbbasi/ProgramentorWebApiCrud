...
using ProgramentorWebApi.Models;

namespace ProgramentorWebApi.Controllers
{
    [Route("api/[controller]")]
    [ApiController]
    public class StudentsAPIController : ControllerBase
    {
        private readonly CollegeAppDbContext context;

        public StudentsAPIController(CollegeAppDbContext context)
        {
